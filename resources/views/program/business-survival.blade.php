...
<head>
    ...
    <title>Program Business Survival | IDN Boarding School</title>
    <meta name="description" content="Santri tidak hanya belajar teori bisnis, tetapi juga mengalami langsung proses berwirausaha di lapangan mulai dari perencanaan, produksi, hingga strategi penjualan dengan modal terbatas.">
...
<body class="bg-[#fafafa] text-[#181d27] font-['Geist',sans-serif] antialiased min-h-screen flex flex-col justify-between selection:bg-[#0c61cf] selection:text-white">
    ...
    <main class="flex-1 w-full pt-[106px]">
            ...
            <div class="max-w-[1240px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-5">
                    ...
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-semibold text-[#0b0d12] tracking-[-2.24px] leading-tight lg:leading-[68px] font-['Funnel_Display',sans-serif]">
                        Bagaimana bertahan & beradaptasi dalam <span class="text-[#0c61cf]">kehidupan nyata.</span>
                    </h1>
                    
                    <p class="text-[#717680] text-sm md:text-base leading-relaxed font-normal max-w-2xl">
                        Santri tidak hanya belajar teori bisnis, tetapi juga mengalami langsung proses berwirausaha di lapangan mulai dari perencanaan, produksi, hingga strategi penjualan dengan modal terbatas.
                    </p>
                </div>
        ...
        <!-- Section 2: Tujuan Program Business Survival -->
            ...
            <div class="max-w-[1120px] mx-auto px-6 md:px-8">
                ...
                <div class="relative flex items-center justify-center gap-3 mb-12 sm:mb-16 text-center max-w-2xl mx-auto">
                    <h2 class="text-2xl sm:text-3xl lg:text-[36px] font-bold text-[#0b0d12] tracking-tight font-['Funnel_Display',sans-serif]">
                        Tujuan Program <span class="text-[#0c61cf]">Business Survival</span>
                    </h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-[18px] border border-[#e9eaeb] shadow-[0px_4px_20px_rgba(0,0,0,0.04)] hover:shadow-xl hover:border-[#0c61cf] transition-all duration-300 flex flex-col justify-between">
                        <div>
                            ...
                            <h3 class="text-lg sm:text-xl font-bold text-[#181d27] font-['Funnel_Display',sans-serif] mb-2 leading-snug">
                                Menumbuhkan Jiwa Wirausaha (Entrepreneurship Mindset)
                            </h3>
                            <p class="text-[#717680] text-sm leading-relaxed font-normal">
                                Santri dilatih untuk berpikir kreatif, berani mengambil risiko, dan mampu menemukan solusi dalam keterbatasan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-[18px] border border-[#e9eaeb] shadow-[0px_4px_20px_rgba(0,0,0,0.04)] hover:shadow-xl hover:border-[#0c61cf] transition-all duration-300 flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-[#717680] text-sm leading-relaxed font-normal">
                                Dengan modal kecil dan waktu terbatas, santri ditantang untuk mengelola keuangan, strategi, dan pembagian tugas secara mandiri.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 lg:p-8 rounded-[18px] border border-[#e9eaeb] shadow-[0px_4px_20px_rgba(0,0,0,0.04)] hover:shadow-xl hover:border-[#0c61cf] transition-all duration-300 flex flex-col justify-between">
                        <div>
                            ...
                            <h3 class="text-lg sm:text-xl font-bold text-[#181d27] font-['Funnel_Display',sans-serif] mb-2 leading-snug">
                                Membangun Kepemimpinan & Kerjasama Tim
                            </h3>
                            <p class="text-[#717680] text-sm leading-relaxed font-normal">
                                Setiap kelompok santri harus menentukan peran, menyusun strategi, dan bekerja sama untuk mencapai target penjualan. Ini melatih kemampuan komunikasi dan manajemen tim.
                            </p>
                        </div>
                    </div>
            ...
            <div class="max-w-[1240px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-5">
                    ...
                    <p class="text-[#717680] text-sm md:text-base leading-relaxed font-normal">
                        Program Business Survival merupakan kegiatan pembelajaran yang dilaksanakan selama beberapa hari di luar lingkungan pesantren. Santri dibagi ke dalam kelompok kecil dan diberikan modal awal yang terbatas untuk membangun serta mengembangkan usaha hingga menghasilkan keuntungan.
                    </p>

                    <p class="text-[#717680] text-sm md:text-base leading-relaxed font-normal">
                        Selama program berlangsung, santri menjalankan berbagai jenis usaha, seperti menjual makanan dan minuman, membuat produk kreatif, atau menawarkan jasa. Mereka juga belajar berinteraksi langsung dengan masyarakat, mengelola keuangan, menghitung keuntungan, serta menyusun laporan sebagai bentuk evaluasi hasil bisnis yang telah dijalankan.
                    </p>
                </div>
            ...
            <div class="max-w-[1240px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                ...
                <div class="lg:col-span-6 flex justify-center">
                    <div class="relative shrink-0 w-full max-w-[455px] h-[260px] sm:h-[330px] my-6 lg:my-0 group/collage">
                        ...
                        <!-- Top-Left Small Tilted Frame (mini-bs-1.avif - 160x100, -rotate-5) -->
                        ...
                        <!-- Bottom-Right Small Tilted Frame (mini-bs-2.avif - 160x100, rotate-5) -->
                ...
                <div class="lg:col-span-6 space-y-5">
                    ...
                    <ul class="list-disc pl-5 space-y-2 text-[#717680] text-sm md:text-base font-normal my-4 marker:text-[#717680]">
                        <li>Berani memulai dan tidak takut gagal.</li>
                        <li>Berpikir strategis dalam keterbatasan.</li>
                        <li>Menjaga amanah dan etika dalam setiap transaksi.</li>
                        <li>Bersyukur atas hasil usaha, sekecil apa pun itu.</li>
                    </ul>

                    <p class="text-[#717680] text-sm md:text-base leading-relaxed font-normal">
                        Lebih dari sekadar latihan bisnis, kegiatan ini adalah latihan hidup — bagaimana bertahan dengan sumber daya terbatas, tetap jujur, dan kreatif dalam menghadapi tantangan.
                    </p>
                </div>
