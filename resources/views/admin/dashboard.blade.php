...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
        ...
        <!-- Card 3: Hak Akses Super Admin -->
        <div class="bg-white p-5 rounded-2xl border border-[#e2e8f0] shadow-sm flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-[#64748b] block mb-1">Hak Akses Role</span>
                <span class="text-2xl font-bold text-[#0f172a] font-['Funnel_Display',sans-serif]">Super Admin</span>
                <span class="text-[11px] text-[#0c61cf] font-medium block mt-1">Akses 100% Penuh</span>
            </div>
